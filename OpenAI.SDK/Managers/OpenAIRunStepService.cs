...
public partial class OpenAIService : IRunStepService
{
    ...
    {
        return await _httpClient.GetReadAsAsync<RunStepListResponse>(_endpointProvider.RunStepList(threadId, runId, request), _providerType, cancellationToken);
    }
    ...
    {
        return await _httpClient.GetReadAsAsync<RunStepResponse>(_endpointProvider.RunStepRetrieve(threadId, runId, stepId), _providerType, cancellationToken);
    }
}